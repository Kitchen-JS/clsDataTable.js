    ...
    setJsonData(jsonData) {
      ...
      jsonData.forEach((row) => {
        Object.keys(this.keyMap).forEach((key) => {
          if (
            typeof this.keyMap[key].remove !== "undefined" &&
            this.keyMap[key].remove
          ) {
      ...
      if (
        typeof this.jsonData === "undefined" ||
        !this.jsonData ||
        this.jsonData.length < 1
      ) {
    ...
    update() {
      if (this.jsonData && this.jsonData.length <= 1) {
        ...
        Object.keys(this.jsonData[0]).forEach((key) => {
          this.keys.push(key);
          if (
            typeof this.filters[key].value === "undefined" ||
            !this.filters[key].value
          ) {
            this.filters[key].value = "";
          }
